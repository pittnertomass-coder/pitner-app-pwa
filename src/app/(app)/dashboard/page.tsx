...
import { Route, Stethoscope, CheckCircle2, TrendingUp, Flame, Star } from "lucide-react";
    ...
    <div className="min-h-full px-5 py-8 md:px-10 md:py-10 max-w-xl mx-auto flex flex-col gap-8">
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <div className="glass rounded-2xl p-5 space-y-4">
          ...
          <div>
            <p className="text-3xl font-bold teal-number leading-none">{completedCount}</p>
            <p className="text-xs text-muted-foreground mt-1.5 leading-snug">splněno</p>
          </div>
        </div>
      </div>
          ...
          <Link href="/poslech">
            <div className="glass glass-hover rounded-2xl p-5 flex items-center gap-4 cursor-pointer group">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-sm text-muted-foreground mt-0.5">Poslech · audio průvodce</p>
              </div>
              <span className="text-primary/40 text-xl font-thin shrink-0">›</span>
            </div>
          </Link>
